...
def get_active_subreddits():
    ...
    def generate_initial_insights(top_5_activities):
        ...
        detail what you would talk about and why you would talk about that: {top_5_activities}"""

        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                    {"role": "system", "content": "You are an analyst who finds out what a reddit user is more interested in and engaged by"},
        ...
        try:
            ...
            for subreddit, posts in top_5_activities:
                ...
                messages=[
                        ...
                        {"role": "assistant", "content": initial_insights},
                        {"role": "user", "content": prompt}
                    ]
                )
